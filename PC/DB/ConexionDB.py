    ...
    def ConsultarCamaras(self, *args):
        ...
        camaras = {
            "3": {
                ...
                "canal": "1",
                "horarioInicio": datetime.time(17, 29, 0),
                "horarioFin": datetime.time(17, 32, 0),
                },
            "4": {
                "iddvr": "1",
                "id": "4",
                ...
                "canal": "2",
                "horarioInicio": datetime.time(17, 29, 0),
                "horarioFin": datetime.time(17, 31, 0),
                },
            "5": {
                "iddvr": "1",
                "id": "5",
                "nombre": "MAQUINA 3D",
                "canal": "3",
                "horarioInicio": datetime.time(17, 20, 0),
                "horarioFin": datetime.time(17, 31, 10),
                },
            "6": {
                "iddvr": "1",
                "id": "6",
                ...
                "canal": "5",
                "horarioInicio": datetime.time(17, 29, 0),
                "horarioFin": datetime.time(17, 30, 0),
                }
        }    
